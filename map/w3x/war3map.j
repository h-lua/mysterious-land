...
sound gg_snd_voice_rect_moon= null
sound gg_snd_voice_rect_rainstorm= null
sound gg_snd_voice_rect_wind= null
sound gg_snd_voice_rect_sea= null
sound gg_snd_voice_rect_sun= null
string gg_snd_bgm_main
string gg_snd_bgm_stage3
string gg_snd_bgm_stage4
string gg_snd_bgm_stage6
string gg_snd_bgm_stage7
string gg_snd_bgm_stage9
...
function InitSounds takes nothing returns nothing
    ...
    set gg_snd_voice_rect_moon=CreateSound("war3mapImported\\voice_rect_moon.mp3", false, false, false, 10, 10, "")
    call SetSoundChannel(gg_snd_voice_rect_moon, 0)
    call SetSoundVolume(gg_snd_voice_rect_moon, 127)
    call SetSoundPitch(gg_snd_voice_rect_moon, 1.0)
    set gg_snd_voice_rect_rainstorm=CreateSound("war3mapImported\\voice_rect_rainstorm.mp3", false, false, false, 10, 10, "")
    call SetSoundChannel(gg_snd_voice_rect_rainstorm, 0)
    call SetSoundVolume(gg_snd_voice_rect_rainstorm, 127)
    call SetSoundPitch(gg_snd_voice_rect_rainstorm, 1.0)
    set gg_snd_voice_rect_wind=CreateSound("war3mapImported\\voice_rect_wind.mp3", false, false, false, 10, 10, "")
    call SetSoundChannel(gg_snd_voice_rect_wind, 0)
    call SetSoundVolume(gg_snd_voice_rect_wind, 127)
    call SetSoundPitch(gg_snd_voice_rect_wind, 1.0)
    set gg_snd_voice_rect_sea=CreateSound("war3mapImported\\voice_rect_sea.mp3", false, false, false, 10, 10, "")
    call SetSoundChannel(gg_snd_voice_rect_sea, 0)
    call SetSoundVolume(gg_snd_voice_rect_sea, 127)
    call SetSoundPitch(gg_snd_voice_rect_sea, 1.0)
    set gg_snd_voice_rect_sun=CreateSound("war3mapImported\\voice_rect_sun.mp3", false, false, false, 10, 10, "")
    call SetSoundChannel(gg_snd_voice_rect_sun, 0)
    call SetSoundVolume(gg_snd_voice_rect_sun, 127)
    call SetSoundPitch(gg_snd_voice_rect_sun, 1.0)
    set gg_snd_bgm_main="war3mapImported\\bgm_main.mp3"
    set gg_snd_bgm_stage3="war3mapImported\\bgm_stage3.mp3"
    set gg_snd_bgm_stage4="war3mapImported\\bgm_stage4.mp3"
    set gg_snd_bgm_stage6="war3mapImported\\bgm_stage6.mp3"
    set gg_snd_bgm_stage7="war3mapImported\\bgm_stage7.mp3"
    set gg_snd_bgm_stage9="war3mapImported\\bgm_stage9.mp3"
endfunction
//***************************************************************************
//*
//*  Unit Creation
